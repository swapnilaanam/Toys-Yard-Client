...
const Footer = () => {
    return (
        <footer className="footer footer-center flex flex-col lg:flex-row justify-between items-center py-20 px-20 bg-black text-white gap-16 lg:gap-8 shadow-sm">
            <div>
